...
## use a dual DDP formulation to solve the DGP,
## then use PCA to project to K dimensions
## then use a local NLP solver to improve solution
## (this version uses the amplpy interface in order to solve dualDDP)
...
dualddp = AMPL(Environment('/Users/czartur/ampl'))
...
nlp = AMPL(Environment('/Users/czartur/ampl'))
nlp.read("dgp.mod")
